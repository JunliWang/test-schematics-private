...
resource "ibm_resource_instance" "es_instance_1" {
  name              = "terraform-integration-private"
  service           = "messagehub"
  plan              = "enterprise-3nodes-2tb" # "lite", "enterprise-3nodes-2tb"
  location          = "eu-fr2" # "us-east", "eu-gb", "eu-de", "jp-tok", "au-syd"
  ...
  parameters = {
    ...
    private_ip_allowlist = "[10.217.20.0/26,10.217.23.192/26,10.218.11.64/26,10.219.14.0/26]" # for enterprise instance only. Specify 1 or more IP range in CIDR format
